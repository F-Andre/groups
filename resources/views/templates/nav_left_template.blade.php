...
<div class="accordion text-center" id="groupAcc">
  <a id="headingGroup" class="btn btn-outline-groups d-flex justify-content-center align-items-center flex-wrap mx-auto" href="#" role="button" data-toggle="collapse"
